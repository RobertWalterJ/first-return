...
- **Mixed looks:** Photo subject (the people or things you picked as the real photo, on the Void stage of dots) and Photo world (the surroundings as the photo, the subject as dots). Each pixel knows whether it is photo or dots, so the photo keeps its own colours while the dots get the filmic curve and glow.
